...
const CommentsApp = () => {
    ...
    React.useEffect(() => {
        ...
        fetch("http://localhost:5080/comments")
    ...
    const handleAddComment = async (newComment) => {
        ...
        try {
            ...
            const response = await fetch("http://localhost:5080/comments", {
                method: "POST",
    ...
    const handleDeleteComments = async () => {
        ...
        try {
            for (const id of selectedIds) {
                ...
                const response = await fetch(`http://localhost:5080/comments/${id}`, {
                    method: "DELETE",
                });
    ...
    const handleSaveEdit = async (updatedComment) => {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:5080/comments/${updatedComment.id}`, {
                method: "PATCH",
                headers: { "Content-Type": "application/json" },
